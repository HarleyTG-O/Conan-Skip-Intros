...
echo Welcome to the File Replacement Script!
echo.
pause

set "source_file=C:\Users\harle\Downloads\Conan-Skip-Intros-Master\Conan-Skip-Intros-Master\Conan Intro Skip - Made By HarleyTG\Default\DefaultGame.ini"
